                        ...
                        specs: [
                            {
                                ...
                                items: [
                                    ...
                                    {
                                        title: "Reliability",
                                        description: "<ol><li>Distributed architecture with cluster deployment.</li><li>Supports cross-region disaster recovery.</li><li>High reliability: 99.999%.</li><ol>"
                                    },
                                    {
                        ...
                        specs: [
                            {
                                ...
                                items: [
                                    ...
                                    {
                                        title: "Features",
                                        description: "<ul><li>Support Audio/Video Transcoding (Voice: AMR-NB, EVS, AMR-WB, G.711A, G.711U, G.722, G.723.1, G.726, G.729A/B, GSM-FR, GSM-EFR, iLBC, etc.,</li></ul>"
                                    },
                                    {
                                        title: "Others",
                                        description: "<ul><li>Reserved for Future Expansion. </li></ul>"
                                    },
                                ],
                                image: null,
                                layout: "secondary",

                    ...
                    <table class="w-full border-collapse border border-[#2B6FF6]/20">
                        ...
                        <tbody>
                            <tr v-for="(item, index) in category.items" :key="index" class="border-b">
                                <td class="border border-gray-300 px-4 py-2 w-1/3 md:w-1/2 text-[#2B6FF6]">{{ item.title }}</td>
                                <td class="border border-gray-300 px-4 py-2 w-2/3 md:w-1/2" v-html="item.description"></td>
                            </tr>
                        </tbody>
                    </table>
                </div>
                ...
                <table class="w-full border-collapse border border-[#2B6FF6]/20">
                    <thead>
                        <tr class="bg-gray-100 text-left">
                            <th class="border border-gray-300 px-4 py-2 w-1/3 md:w-1/2 text-[#2B6FF6]">Item</th>
                            <th class="border border-gray-300 px-4 py-2 w-2/3 md:w-1/2">Specification</th>
                        </tr>
                    </thead>
                    <tbody>
